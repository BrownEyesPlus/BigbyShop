...
export default function PurchaseProduct({ data }) {
  console.log(data.product.product_color?.image)

  return (
    <tr className="alert" role="alert">
      <td>
        <div className="img" style={{ background: `url:('${data.product.product_color?.image}')` }} >
          <img src={data.product.product_color?.image} alt="" />
        </div>
      </td>
      <td>
        <div className="email">
