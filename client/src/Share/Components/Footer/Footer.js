  ...
  return (
    <div className='footer'>
      <div className="footer-wrap">
          <div className="top-footer container row">
            ...
            <div className="about-us-footer">
              ...
              <ul className="contact-footer-menu">
                ...
                <li>
                  <i className="fa fa-envelope"/> Email: linhmypham98@gmail.com
              </li>
              </ul>
            </div>
        ...
        <p className="text-center" style={{padding:5, color: 'gray'}}>Copyright © 2022 LinhMyPham. All rights reserved </p>
    </div>
  )
}
